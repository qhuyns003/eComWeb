package com.ecomweb.notification_service.exception;
...
public enum ErrorCode {
    ...
    UNAUTHENTICATED(1006, "Unauthenticated in notification", HttpStatus.UNAUTHORIZED),
    ...
    NOTIFICATION_NOT_FOUND(1025, "Thong bao khong ton tai", HttpStatus.BAD_GATEWAY),
