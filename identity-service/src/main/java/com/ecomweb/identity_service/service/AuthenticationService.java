...
import com.ecomweb.identity_service.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    private String buildScope(User user) {
        ...
        List<String> userRoles = userRoleRepository.findByUserId(user.getId())
                .stream().map(ur -> ur.getRoleId().toString()).collect(Collectors.toList());
        List<Role> roles = roleRepository.findByIdIn(userRoles);
        // khong goi querry trong vong for -> bi nhieu roundtrip giam performance
